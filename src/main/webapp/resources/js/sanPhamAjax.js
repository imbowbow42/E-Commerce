$(document).ready(function() {
	...
	function ajaxGet(page){
		...
		$.ajax({
			...
			url: "http://localhost:8088/api/san-pham/all" + '?page=' + page,
    ...
    function ajaxPostLapTop() {
    	// PREPATEE DATA
    	 ...
    	 $.ajax({
 			...
 			type : "POST",
 			contentType : "application/json",
 			url : "http://localhost:8088/api/san-pham/save",
    ...
    $(document).on("click",".btnCapNhatLapTop", function(event){
		...
		var href = "http://localhost:8088/api/san-pham/"+sanPhamId;
    ...
    $(document).on("click",".btnXoaSanPham", function() {
		...
		if(confirmation){
		  $.ajax({
			  async:false,
			  type : "DELETE",
			  url : "http://localhost:8088/api/san-pham/delete/" + sanPhamId,
